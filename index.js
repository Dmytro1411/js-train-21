...
class Musician {
  ...
  play() {
    ...
    log(`${this.#name} грає на ${this.#instrument}`);
  }
}
// Musician.count += 1;
...
class Guitarist extends Musician {
  ...
  play() {
    ...
    log(`${super.name} грає на ${super.instrument} в групі ${this.#band}`);
  }
}
...
Object.defineProperty(Musician.prototype, "band", {
  ...
  set(newBand) {
    this.band = newBand; // тому ми вказуємо функцію, яка буде викликатися при спробі встановити властивість 'band'.  this.band = newBand
  },
});
...
//     } else {
//       log("Новий учасник повинен бути екземпляром класу Musician"); // Якщо ні виводимо в консоль повідомлення Новий учасник повинен бути екземпляром класу Musician
//     }
//   }
...
class Vocalist {
  ...
  // Створюємо getter для #band, що повертає приватну властивість #
  get band() {
    return this.#band;
  }
  ...
  info() {
    log(`Вокаліст ${this.name} є членом гурту ${this.band}`);
  }
}
...
class SongWriter {
  ...
  info() {
    log(`Написав ${this.songs.length} пісень`);
  }
}
...
log("LeadSinger", LeadSinger.prototype);
/*
